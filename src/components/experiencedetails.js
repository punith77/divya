          ...
          <div>
            <div className='experience-item item-container'>
              ...
              <ul className='experience-highlights'>
                ...
                <li>
                  Responsible for code merging using Microsoft Team Foundation
                  Server (TFS) and for other source code maintenance needs
                </li>
              </ul>
          ...
          <div>
            <div className='experience-item item-container'>
              ...
              <ul className='experience-highlights'>
                ...
                <li>
                  Hardened my skills in Object Oriented and Database Programming{" "}
                </li>
                <li>
                  Completed multiple projects during my stay at university -
                  Please refer to mu git hub for details.
                </li>
              </ul>
              <h4>Technologies Used</h4>
              <table width='100%'>
